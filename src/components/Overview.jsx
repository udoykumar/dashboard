      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-3 ">
        <div className=" bg-linear-to-b from-secondary to-secondary-dull p-5 rounded-4xl group hover:shadow-xl transition-all duration-300">
          <div className="flex justify-between ">
            <p className="text-white font-bold text-2xl">TotalUsers</p>
            <button className="bg-white rounded-full  p-4">
              <FaArrowRight className="-rotate-45  group-hover:rotate-0 duration-300" />
            </button>
          </div>
          <p className=" font-bold text-white py-5 text-5xl ">{totalUsers}</p>
        </div>
        <div className=" p-5 rounded-4xl group hover:shadow-xl t bg-white transition-all duration-300">
          <div className="flex justify-between ">
            <p className=" font-bold text-2xl ext-black">Active Users</p>
            <button className=" rounded-full  p-4 border">
              <FaArrowRight className="-rotate-45  group-hover:rotate-0 duration-300" />
            </button>
          </div>
          <p className=" font-bold  py-5 text-5xl ">{activeUsers}</p>
        </div>
        <div className=" p-5 rounded-4xl group hover:shadow-xl t bg-white transition-all duration-300">
          <div className="flex justify-between ">
            <p className=" font-bold text-2xl ext-black">Revenue</p>
            <button className=" rounded-full  p-4 border">
              <FaArrowRight className="-rotate-45  group-hover:rotate-0 duration-300" />
            </button>
          </div>
          <p className=" font-bold  py-5 text-5xl ">${revenue}</p>
        </div>
        <div className=" p-5 rounded-4xl group hover:shadow-xl t bg-white transition-all duration-300">
          <div className="flex justify-between ">
            <p className=" font-bold text-2xl ext-black">Growth</p>
            <button className=" rounded-full  p-4 border">
              <FaArrowRight className="-rotate-45  group-hover:rotate-0 duration-300" />
            </button>
          </div>
          <p className=" font-bold  py-5 text-5xl ">{growth}</p>
        </div>
      </div>
    </div>
  );
